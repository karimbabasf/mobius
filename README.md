...
MOBI board is a macOS desktop app for watching local AI coding agents in one live
...
![MOBI board dashboard](mobi-board-dashboard.png)

## Status

MOBI board currently observes Claude Code, Codex, and Hermes sessions. Cursor support
